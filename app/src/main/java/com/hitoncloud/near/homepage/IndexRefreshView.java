 ...
 * 
 */
public class IndexRefreshView extends LinearLayout {
	...
	public IndexRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public IndexRefreshView(Context context) {
		super(context);
		init();
	}
...
//		}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(IndexRefreshView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(IndexRefreshView view);
	}
}
