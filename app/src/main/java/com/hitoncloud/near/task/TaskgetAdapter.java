...
public class TaskgetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{

    private List<Taskgetlist> Taskgetlists;//详细任务列表
    ...
    public TaskgetAdapter(List<Taskgetlist> list, Context context){
        Taskgetlists = list;
        mContext=context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        Taskgetlist Taskgetlist = Taskgetlists.get(position);
        item_taskname = Taskgetlist.getName();
        item_tasktime = Taskgetlist.getPuttime();
        item_taskmoney = Taskgetlist.getMoney();
        item_taskputter = Taskgetlist.getPutter();
        item_ordernum = Taskgetlist.getOrdernum();
